...
//     — bukan tombol lain di sekitarnya — dengan delay 1s sebelum muncul (transition-delay CSS,
...
//
// `variant`:
//   - "overlay" (default, Tab Table) — absolute di pojok kiri cell, `.row-quicksend` (delay 1s
